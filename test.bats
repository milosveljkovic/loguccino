...
# @test "Scenario 8 : Create level N archives" {
#     cd build/libs/
#     mkdir -p leveln
#     cd level2/zip
...
#     run zip ./spring.zip spring.cpio
#     [ "$status" -eq 0 ] 

#     run ar r ./spring.ar spring.zip # ar/zip/cpio/tar/zip/zip
#     [ "$status" -eq 0 ]

#     rm -i !(*.ar) # remove all files other than .ar
# }

@test "Scenario 9 : Scan level N archives" {
